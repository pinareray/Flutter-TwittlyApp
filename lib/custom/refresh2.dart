...
///
/// {@tool dartpad}
/// This example shows how to use [RefreshIndicator2] without the spinner.
///
...
class RefreshIndicator2 extends StatefulWidget {
  ...
  /// Called to get the current status of the [RefreshIndicator2] to update the UI as needed.
  ...
  /// Defines the elevation of the underlying [RefreshIndicator2].
  ///
  /// Defaults to 2.0.
